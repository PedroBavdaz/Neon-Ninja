...
public class MinigunBoss : MonoBehaviour
{
    ////////////////////////////////
    //floats
    ...
    public Vector3 bulletflashoffset = new Vector3();
    ...
    void Flip()
    {
        ...
        walkSpeed *= -1;
        bulletflashoffset = new Vector3(-bulletflashoffset.x, bulletflashoffset.y, 0);
        mustPatrol = true;
    }
